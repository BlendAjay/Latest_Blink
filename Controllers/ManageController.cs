        ...
        public async Task<ActionResult> ChangePassword(ChangePasswordViewModel model)
        {
            ...
            if (model.NewPassword == model.ConfirmPassword)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    return RedirectToAction("ChangePassword", new { Id = "Succeeded" });
                }
                else
                {
                    return RedirectToAction("ChangePassword", new { Id = "Failed" });
                }
            }
            else
            {
                return RedirectToAction("ChangePassword", new { Id = "NoMatch" });
            }
            //AddErrors(result);
            //return View(model);
